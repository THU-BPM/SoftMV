...
def init_iter_module(model_config, train_config, eval_config, ddp_config, dataset, output_dir):
    wrapper = init_model(model_config, train_config)
    if not ddp_config.do_ddp:
        ...
        eval_batch_size = eval_config.pet_per_gpu_eval_batch_size * 2
    ...
    data_iterator.patternize_trn(output_dir)
        ...
        for iteration in range(repetitions):
            ...
            if do_train:
                if ddp_config.do_ddp:
                    ...
                    data_iterator, _ = init_iter_module(
                        model_config, train_config, eval_config, ddp_config, dataset, pattern_iter_output_dir
                    )
            ...
            if do_eval:
                ...
                test_data_iterator, _ = init_iter_module(
                    model_config, _train_config, eval_config, ddp_config, dataset, pattern_iter_output_dir
                )
                lang2evalscores = {}
                lang2predictions = {}
                avg_acc = 0
